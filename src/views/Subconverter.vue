      ...
      options: {
        ...
        remoteConfig: [
            ...
            options: [
              ...
              {
                label: "OpenClash机场版",
                value: "https://raw.githubusercontent.com/utopia0051/my-sub-rules/main/config/openclash-jichang.ini"
              },
              {
                label: "OpenClash二合一版",
